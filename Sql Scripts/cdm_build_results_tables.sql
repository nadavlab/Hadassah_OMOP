...
-- http://132.72.65.168:8080/WebAPI/ddl/results?dialect=postgresql&schema=results&vocabSchema=omop_demo&tempSchema=temp&initConceptHierarchy=true
...
LEFT JOIN (
	...
	FROM omop_demo.concept c1
	INNER JOIN omop_demo.concept_ancestor ca1 ON c1.concept_id = ca1.descendant_concept_id
		AND c1.domain_id = 'Condition'
		AND ca1.min_levels_of_separation = 1
	INNER JOIN omop_demo.concept c2 ON ca1.ancestor_concept_id = c2.concept_id
...
LEFT JOIN omop_demo.concept soc ON hlgt_to_soc.soc_concept_id = soc.concept_id;
...
LEFT JOIN omop_demo.concept atc1 ON atc3_to_atc1.atc1_concept_id = atc1.concept_id;
...
FROM (
	SELECT DISTINCT
		concept_id,
		concept_name
	FROM omop_demo.concept c
	WHERE domain_id = 'Measurement'
) m
LEFT JOIN omop_demo.concept_ancestor ca1 ON M.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN omop_demo.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN omop_demo.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN omop_demo.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN omop_demo.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
LEFT JOIN omop_demo.concept c3 ON ca3.ANCESTOR_CONCEPT_ID = c3.concept_id
...
LEFT JOIN omop_demo.concept_ancestor ca1 ON obs.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN omop_demo.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN omop_demo.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN omop_demo.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN omop_demo.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
...
(
	...
	FROM omop_demo.concept c1
	INNER JOIN omop_demo.vocabulary v1 ON c1.vocabulary_id = v1.vocabulary_id
...
LEFT JOIN (
	...
	FROM omop_demo.concept_ancestor ca0
	INNER JOIN (
		SELECT DISTINCT c2.concept_id AS os3_concept_id
		FROM omop_demo.concept_ancestor ca1
		INNER JOIN omop_demo.concept c1 ON ca1.DESCENDANT_CONCEPT_ID = c1.concept_id
		INNER JOIN omop_demo.concept_ancestor ca2 ON c1.concept_id = ca2.ANCESTOR_CONCEPT_ID
		INNER JOIN omop_demo.concept c2 ON ca2.DESCENDANT_CONCEPT_ID = c2.concept_id
