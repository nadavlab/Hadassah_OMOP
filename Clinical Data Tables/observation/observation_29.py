...
for index_row, row in source_table.iterrows():
    ...
    # TODO
    observation_concept_id = 0  # "היסטוריית ניתוחים"

    observation_datetime = datetime.strptime(row[13], '%d/%m/%Y %H:%M:%S')
    ...
    value_as_string = ""
    if row[3] == "[אבחנה ללא קוד]":
        value_as_string = row[12]
    else:
    ...
    observation_source_value = "היסטוריית ניתוחים"
...
df_result.to_csv('observation_29.csv', encoding='utf-8', index=False)
